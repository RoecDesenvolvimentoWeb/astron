...
interface IMolLoadMoreActiveAlertsProps {
    onLoadMore: () => unknown
}

export const MolLoadMoreActiveAlerts = (props: IMolLoadMoreActiveAlertsProps): ReactElement => {
    return (
        <>
            <div className="w-full py-[40px] h-[32.4px] flex items-center justify-center bg-white border-y-[1px] border-solid border-[#E5E6E5]">
                <svg onClick={props.onLoadMore} className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
