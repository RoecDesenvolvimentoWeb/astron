...
interface IMolPaymentAccountProps {
    icon: ReactNode;
    accountName: string;
    isBinded: boolean;
    href: string;
...
export const MolPaymentAccount = (
    props: IMolPaymentAccountProps
): ReactElement => {
    ...
    return (
        <>
            <div className="max-w-[600px] min-w-[600px] min-h-[216px] max-md:flex-col max-md:w-full max-md:min-w-full md:max-h-[216px] rounded-[16px] bg-white flex flex-row">
                <div className="h-full max-md:w-full w-1/4 min-w-[194px] min-h-[216px] rounded-l-lg flex items-center justify-center bg-[#E7DDF5] max-md:rounded-t-lg max-md:rounded-r-lg max-md:rounded-br-none max-md:rounded-bl-none">
                    {props.icon}
                </div>
              ...
              Vincule sua conta ao Mercado Pago
                        </div>
              ...
              acesso instantâneo aos seus recebimentos
                        ...
                        {width <= 768 ? (
                            !props.isBinded ? (
                                ...
                                >
                                    ...
                                    >
                                        <g clip-path="url(#clip0_1081_952)">
                                            <path
                    ...
                    Desvincular
                            ...
                            <div className="flex flex-row gap-x-[55px] justify-between items-center max-md:flex-col">
                                {!props.isBinded ? (
                                    <AtomBtn
                                        onClick={(): void => {
                                            location.href = props.href;
